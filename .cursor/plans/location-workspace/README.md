...
Related Cursor plans for the **location editor workspace** (dirty/save, authoring contract, persistable assembly, debounced flush, normalization policy, hex edges, Select mode). All live in this directory so links stay stable.

              ...
              <List component="nav" disablePadding sx={{ mt: 1 }}>
                ...
                {canAccessAdmin && (
                  <>
                    ...
                    <ListItemButton
                      component={NavLink}
                      to={activeCampaignId ? ROUTES.CAMPAIGN_COMBAT_TEST.replace(':id', activeCampaignId) : ROUTES.CAMPAIGNS}
                      selected={activeCampaignId ? location.pathname === ROUTES.CAMPAIGN_COMBAT_TEST.replace(':id', activeCampaignId) : false}
                      sx={{ pl: 0 }}
                    >
                      <ListItemIcon sx={{ minWidth: 36 }}><ShieldIcon fontSize="small" /></ListItemIcon>
                      <ListItemText primary="Combat Test" slotProps={{ primary: { fontSize: '0.85rem' } }} />
                    </ListItemButton>

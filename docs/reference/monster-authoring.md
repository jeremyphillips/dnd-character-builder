...
- Factory defaults live in [`monsters.ts`](../../src/features/mechanics/domain/rulesets/system/monsters.ts) and [`monsters-catalog-append.ts`](../../src/features/mechanics/domain/rulesets/system/monsters-catalog-append.ts) (appended entries).

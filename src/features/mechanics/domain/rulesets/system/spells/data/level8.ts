...
export const SPELLS_LEVEL_8: readonly SpellEntry[] = [
  ...
  },
  {
    ...
    effects: [
      {
        kind: 'note',
        text: '150 HP or fewer: Stunned. Otherwise Speed 0 until start of your next turn. Stunned: Con save at end of each turn to end.',
      },
    ],
    description: {
  ...
  },
  {
    ...
    effects: [
      {
        kind: 'note',
        text: '60ft radius sphere. Con save or 12d6 Radiant + Blinded 1 min. Con save at end of each turn to end Blinded. Dispels Darkness in area.',
      },
    ],
    description: {

...
| [location_workspace_object_authoring_phase4_config_editing.plan.md](location_workspace_object_authoring_phase4_config_editing.plan.md) | **Child (Phase 4)** | **Config and editing** — shared placed-object rail template, inspector ownership, Label rules, persistence notes, `location-workspace.md` updates. **Not** full workspace/runtime redesign. |
| [location_workspace_object_authoring_phase4_build_plan.md](location_workspace_object_authoring_phase4_build_plan.md) | **Phase 4 execution** | **Implementation build plan** — milestones M1–M7, file map, sequencing, definition of done. Normative spec remains Phase 4 config/editing plan. |

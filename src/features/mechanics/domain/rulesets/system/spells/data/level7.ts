...
export const SPELLS_LEVEL_7: readonly SpellEntry[] = [
  ...
  },
  {
    ...
    effects: [{ kind: 'note', text: 'Chosen creatures Cha save. By HP: 0-20 die, 21-30 Blinded+Deafened+Stunned 1h, 31-40 Blinded+Deafened 10min, 41-50 Deafened 1min. Celestial/Elemental/Fey/Fiend: fail=banished 24h.' }],
    description: {
  ...
  },
  {
    ...
    level: 7,
    classes: ['wizard'],
    castingTime: { normal: { value: 12, unit: 'hour' } },
    range: { kind: 'touch' },
    duration: { kind: 'until-dispelled' },

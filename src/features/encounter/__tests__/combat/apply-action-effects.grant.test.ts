...
import { applyActionEffects } from '@/features/mechanics/domain/combat/resolution/action/action-effects'
...
import { deriveRuntimeEffects } from '@/features/mechanics/domain/combat/state/shared'

export const proficiencies = {
  '5e': {
    skills: {
      acrobatics: { id: 'acrobatics', name: 'Acrobatics', ability: 'dexterity', description: 'Staying on your feet in tricky situations, like walking across a tightrope or icy surface.' },
      animalHandling: { id: 'animalHandling', name: 'Animal Handling', ability: 'wisdom', description: 'Calming domesticated animals, intuiting an animal’s intentions, or controlling a mount.' },
      arcana: { id: 'arcana', name: 'Arcana', ability: 'intelligence', description: 'Recall lore about spells, magic items, eldritch symbols, and planes of existence.' },
      athletics: { id: 'athletics', name: 'Athletics', ability: 'strength', description: 'Difficult situations you face while climbing, jumping, or swimming.' },
